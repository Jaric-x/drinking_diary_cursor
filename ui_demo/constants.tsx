...
// Icons designed to look like SF Symbols (Stroke width 1.5 - 2 approx)
...
export const IconWineGlass: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6.75c0 2.485-2.015 4.5-4.5 4.5s-4.5-2.015-4.5-4.5S9.515 2.25 12 2.25s4.5 2.015 4.5 4.5z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 11.25v8.25m-3.75 0h7.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 4.5c0-.8.4-1.5 1-2h7c.6 0 1.2.7 1.2 1.5l.3 2.5c0 3.5-3 6.5-5 6.5s-5-3-5-6.5l.5-2z" strokeOpacity={0} />
  </svg>
);
...
export const IconTag: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.593l6.202-2.073c1.154-.386 1.552-1.916.659-2.809L13.158 5.41a2.25 2.25 0 00-1.591-.659h-2v.01zM7.5 7.5h.008v.008H7.5V7.5z" />
    </svg>
);
...
export const INITIAL_NOTES = [
  {
    ...
    description: 'Perfectly balanced bitterness and sweetness. The orange peel adds a lovely aroma.',
    location: 'The Campbell',
    price: 24
  },
  {
    id: '4', // Same date as Note 1 to test stack switching
    title: 'Manhattan',
    date: '10.24',
    time: '22:15',
    rating: 4,
    ...
    description: 'Smooth and sophisticated. A timeless classic for the evening.',
    location: 'Employees Only',
    price: 22
  },
  {
    id: '5', // 3rd note for 10.24
    title: 'Vesper Martini',
    date: '10.24',
    time: '23:45',
    rating: 5,
    tags: ['Gin', 'Vodka', 'Lillet'],
    imageUrl: 'https://images.unsplash.com/photo-1629246522511-2a9452b41490?auto=format&fit=crop&w=800&q=80',
    description: 'James Bond style. Crisp, strong, and extremely elegant.',
    location: 'Dukes Bar',
    price: 28
  },
  {
    ...
    time: '18:45',
    rating: 4,
    tags: ['Cocktail', 'Bittersweet'],
    imageUrl: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&w=800&q=80',
    description: 'A lighter mistake. Prosecco adds a lovely sparkle compared to the gin version.',
    location: 'Dante NYC',
    price: 18
  },
  {
    ...
    description: 'Simple yet elegant. The carbonation really opens up the whisky flavors.',
